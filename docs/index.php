...
<html lang="en">
  ...
  <body>
    ...
    <section id="cities" class="section-cities js--wp-3">
      <div class="row">
        <h2>Title: We're currently in these cities</h2>
      </div>
      <div class="row">
        <div class="col span-1-of-4 box">
    ...
    <section class="section-testimonials">
      <div class="row">
        <h2>Or customers can't live without us</h2>
        <div class="row">
          <div class="col span-1-of-3">
            <blockquote cite="">
              Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
              <cite> <img src="resources/img/customer-1.jpg" alt="customer one">Alberto Duncan</cite>
            </blockquote>
          </div>
          <div class="col span-1-of-3">
            <blockquote cite="">
              Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
              <cite> <img src="resources/img/customer-2.jpg" alt="customer one">Joana Silva</cite>
            </blockquote>
          </div>
          <div class="col span-1-of-3">
            <blockquote cite="">
              I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
              <cite> <img src="resources/img/customer-3.jpg" alt="customer one">Milton Chapman</cite>
            </blockquote>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col span-1-of-3">
          <div class="plan-box js--wp-4">
            ...
            <div class="">
              <ul>
                <li><i class="ion-ios-checkmark-empty icon-small"></i>One meal every day</li>
        ...
        <div class="col span-1-of-3">
          <div class="plan-box">
            ...
            <div class="">
              <ul>
                <li><i class="ion-ios-checkmark-empty icon-small"></i>One meal</li>
                <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 24/7</li>
          ...
          <form class="contact-form" action="mailer.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col span-2-of-3">
                <input id="name" type="text" name="name" value="" placeholder="Your name" required>
              </div>
            </div>
            <div class="row">
              <div class="col span-1-of-3">
            ...
            <div class="row">
              ...
              <div class="col span-2-of-3">
                <select id="find-us" class="" name="find-us">
            ...
            <div class="row">
              ...
              <div class="col span-2-of-3">
                <input id="news" type="checkbox" name="news" value="" checked> Yes, please
              </div>
            </div>
            <div class="row">
              <div class="col span-1-of-3">
...
/*
Google Maps API Key:
AIzaSyBNzPRxjajcH7rbIJgnfBvmbxuviF7-i0w
*/
